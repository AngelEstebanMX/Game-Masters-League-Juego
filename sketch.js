...
function preload(){
 ...
 restarImg = loadImage("reinicio.png")
}
...
function setup() {
 ...
 restart.addImage("over",restarImg);
 restart.visible=false
 restart.scale=0.5
 suelo = createSprite(10,250,1000,10)
 suelo.visible=false
 arbol = createSprite(300,160,100,100);
...
if(gameState==="play"){
 ...
 textSize(20)
 fill("orange")
 text("Presiona para reintentar",200,220)
